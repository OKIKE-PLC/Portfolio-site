...
export default function Residential() {
    return (
        <section className='flex flex-col justify-center items-center' style={{padding: ' 0 .6rem '}}>
            {/* header section */}
            <motion.header 
                className="hero flex flex-col justify-end items-start h-screen w-screen bg-cover bg-no-repeat bg-center" 
                style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('${residential}')`, padding: "0 1rem" }}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            >
                <div className='flex flex-col justify-end items-start gap-2 z-10' style={{padding: "7rem 0"} }>
                    ...
                    <h1 className='font-bold  text-4xl md:text-5xl'>Residential</h1>
                </div>
            </motion.header>
